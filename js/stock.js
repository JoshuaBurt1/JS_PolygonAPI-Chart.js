...
const apiUrlSP = `https://api.polygon.io/v3/reference/tickers?type=CS&market=stocks&exchange=XNAS&active=true&limit=1000&sort=ticker&apiKey=4pSeXh8haEVC16WyDf9oaEnfZdImFgtI`;
...
function chartGen() {
  for (i = 0; i < stockSymbol.length; i++) {
    ...
    //GITHUB PAGES SECRET METHOD
    var apiUrl = `https://api.polygon.io/v2/aggs/ticker/${stockSymbol[i]}/range/1/day/2023-06-01/${formattedDate}?apiKey=4pSeXh8haEVC16WyDf9oaEnfZdImFgtI`;
